# Praat script "Mono speech noise combination"

# This Praat script takes a directory of sound files and a directory of noise files, combines the stimuli with the noise at a specified SNR in one channel, and writes the resultant mono sounds as .wav files in a specified directory.
...
for i from 1 to nStim
	...
	noiseRMS_adj = Get root-mean-square... 0 0
	actual_SNR = 20 * log10(soundRMS / noiseRMS_adj)
	appendInfoLine: "Achieved SNR (before mixing) = ", fixed$(actual_SNR, 2), " dB"
	appendInfoLine: tab$
	...
	# Write the output
	select mono
	Save as WAV file... 'output_folder$'mono_SNR_'desired_SNR'_'soundname$'
